  ...
  <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div class="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" class="inline-flex items-center">
        <svg class="w-8 text-deep-purple-accent-400 text-blue-600" viewBox="0 0 24 24" stroke-linejoin="round" stroke-width="2" stroke-linecap="round" stroke-miterlimit="10" stroke="currentColor" fill="none">
    ...
    <div class="space-y-2 text-sm">
      <p class="text-lg font-bold tracking-wide text-gray-800">CONTACT</p>
      <div class="flex">
    ...
    <div>
      <span class="text-lg font-bold tracking-wide text-gray-800">SOCAIL</span>
